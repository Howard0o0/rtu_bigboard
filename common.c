...
case 1:
  ...
  case 10:
    ...
    break;
  case 11:
    if ((_time[2] - 1) % 2 == 0 && _time[3] == 0 && _time[4] == 0)
      return 1;
    break;
  case 12:
    if ((_time[2] - 1) % 3 == 0 && _time[3] == 0 && _time[4] == 0)
      return 1;
    break;
  case 13:
    if ((_time[2] - 1) % 5 == 0 && _time[3] == 0 && _time[4] == 0)
      return 1;
    break;
  case 14:
    if ((_time[2] - 1) % 10 == 0 && _time[3] == 0 && _time[4] == 0)
      return 1;
    break;
  case 15:
    if ((_time[2] - 1) % 15 == 0 && _time[3] == 0 && _time[4] == 0)
      return 1;
    break;
  case 16:
